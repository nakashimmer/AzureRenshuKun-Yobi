...
<html lang="ja">
	...
	<body>
		<p><audio src="media/myAudio.mp3" controls loop></audio></p>
	</body>
</html>`;
});
...
<html lang="ja">
	...
	<body>
		<p><audio src="media/myAudio.mp3" controls loop></audio></p>
		<p><video src="media/myVideo.mp4" controls loop playsinline></video></p>
	</body>
</html>`;
});
...
<html lang="ja">
	...
	<body>
		...
		<p><button onclick="btn1();">ボタン１</button></p>
		<p id="output1">出力場所</p>
		<script>
...
<html lang="ja">
	...
	<body>
		<audio id="audio1" src="media/myAudio.mp3" loop></audio>
		<p>
